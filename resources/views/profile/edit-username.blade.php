{{-- resources/views/profile/edit-username.blade.php --}}
<x-app-layout>
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center">
                ...
                <h1 class="text-2xl font-semibold text-gray-900">Ubah Username</h1>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <form method="POST" action="{{ route('profile.update-username') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Username dapat berisi huruf, angka, dan underscore</p>
                        @error('username')
