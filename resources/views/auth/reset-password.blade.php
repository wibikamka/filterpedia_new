...
.strength-label { font-size: .7rem; color: #94a3b8; }
...
<div class="page">
    ...
    <div class="side-info">
        <a href="{{ route('login') }}" class="logo">
            ...
            <span class="logo-text">filter<em>pedia</em></span>
        </a>
        <div class="img-intro">
    ...
    <div class="side-glass">
        <div class="fcard">
            ...
            <div class="ftitle">Buat Kata Sandi Baru</div>
            <div class="fsub">Masukkan kata sandi baru yang kuat untuk akun Anda</div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="fg">
                    <label class="flabel" for="password">Kata Sandi Baru</label>
                ...
                <div class="fg">
                    <label class="flabel" for="password_confirmation">Konfirmasi Kata Sandi</label>
                    <input id="password_confirmation" class="finput" type="password"
                        name="password_confirmation"
                        placeholder="Ulangi kata sandi baru"
                        required autocomplete="new-password" />
                    @error('password_confirmation') <div class="ferr">{{ $message }}</div> @enderror
                </div>
